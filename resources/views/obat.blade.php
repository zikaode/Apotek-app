...
@section('Modal')
                    ...
                    <div class="modal-body container">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <input type="text" class="form-control form-control-sm" name="expired"
                                    placeholder="Tanggal Expired" onfocus="(this.type='date')" required>
                            </div>
                        </div>
                        <div class="row
                                    mb-2">
                            <div class="mb-3 col-3">
                                ...
                                <input type="number" class="form-control form-control-sm" name="stokAwal"
                                    value="0" required>
                            </div>
                            <div class="mb-3 col-3">
    ...
    @foreach ($obat as $item)
        <div class="modal fade" id="modalEditUser{{ $item->id }}" tabindex="-1" aria-labelledby="ModalTambahUser"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Edit Obat {{ $item->kode }}</h1>
                        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('obat.update', [$item->id]) }}" method="POST">
                        @csrf
                        <input type="hidden" class="form-control form-control-sm" name="last_kode"
                            value="{{ $item->kode }}">
                        <div class="modal-body container">
                            <div class="row mb-2">
                                <div class="mb-3 col-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="kode"
                                            required value="{{ $item->kode }}" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 col-6">
                                    <label class="form-label">Nama</label>
                            ...
                            <div class="row
                                ...
                                <div class="mb-3 col-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="stokAwal"
                                        value="{{ $item->stok }}" required readonly>
                                </div>
                                <div class="mb-3 col-3">
                                    <label class="form-label">Minimal Stok</label>
                                    <input type="number" class="form-control form-control-sm" name="stokMin"
                                        value="{{ $item->minimum }}" required>
                                </div>
                                <div class="mb-3 col-3">
                                    <label class="form-label">Maximal Stok</label>
                                    <input type="number" class="form-control form-control-sm" name="stokMax"
                                        value="{{ $item->maximum }}" required>
                                </div>
                                <div class="mb-3 col-3">
                                    <label class="form-label">Satuan</label>
                                    <input type="text" class="form-control form-control-sm" name="satuan" required
                            ...
                            <div class="row mb-2" x-data="editObat{{ $item->id }}" x-init="$watch(['hargaJual', 'hargaJualFix'], () => hargaJualFix = (Math.ceil((hargaJual / 1000) * 2) / 2) * 1000)"
                                x-effect="hargaJualFix = (Math.ceil((hargaJual / 1000) * 2) / 2) * 1000">
                                <div class="mb-3 col-2">
                                    <label class="form-label">PPN</label>
                                    <div class="input-group input-group-sm">
                                ...
                                <div class="mb-3 col-2">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="number" class="form-control form-control-sm"
                                            x-model.number="margin" name="margin" required>
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
                                <div class="mb-3 col-4">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text">Rp. </span>
                                        <input type="number" class="form-control form-control-sm"
                                            x-model.number="hargaBeli" name="hargaBeli" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-4">
                                    <label class="form-label">Harga Jual</label>
